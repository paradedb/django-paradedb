...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "CosineDistance": ("paradedb.vector", "CosineDistance"),
    "InnerProduct": ("paradedb.vector", "InnerProduct"),
    "L2Distance": ("paradedb.vector", "L2Distance"),
    "VectorField": ("paradedb.vector", "VectorField"),
    ...
    "Boost": ("paradedb.search", "Boost"),
    "Const": ("paradedb.search", "Const"),
    "Exists": ("paradedb.search", "Exists"),
    "Fuzzy": ("paradedb.search", "Fuzzy"),
    "FuzzyTerm": ("paradedb.search", "FuzzyTerm"),
    "MatchAll": ("paradedb.search", "MatchAll"),
    "MatchAny": ("paradedb.search", "MatchAny"),
    ...
    "Slop": ("paradedb.search", "Slop"),
    "Term": ("paradedb.search", "Term"),
    "TermSet": ("paradedb.search", "TermSet"),
    "Tokenized": ("paradedb.search", "Tokenized"),
